...
历史记录中指向当前工作树的正式笔记路径统一映射为 `.agents/agent_notes/`，便于从当前仓库阅读。固定提交或发布 tag 的证据链接保留对应版本中的原路径，不能随现行目录更名。原验证日期、提交身份、结果及限制保持其历史范围；路径更新不表示重新执行了历史检查。

| 日期 | 记录 |
| --- | --- |
| 2026-09-18 | [agent_notes 更名与 CI / AI 审查分工](2026-09-18-agent-notes.md)：目录、Markdown 引用、稳定 ID、指令链接与现行平台设置 |
| 2026-09-18 | [公开前的历史资料与旧 PR 清理](2026-09-18-public-preparation.md)：可写历史、旧分支、本地原件与扫描；GitHub 旧 PR 引用仍待 Support，仓库保持 private |
| 2026-09-18 | [核心 v0.1.3 与完整项目 v0.1.4 源码发布交接](2026-09-18-source-release.md)：固定提交、当前 CI、annotated tag 与远端 peeled commit |
| 2026-09-16 / 09-18 | [核心 0.1.3 与前端 0.1.4 版本准备](2026-09-16-release-0.1.3.md)：版本元数据、干净安装、回归、主干同步与发布边界 |
...
- [2026-09-15 本机服务与招聘工作流](2026-09-15-studio-service.md)：第二层服务和真实引擎合成测试，前端验收另记。
- [CI 分组、诊断与汇总门槛](2026-09-17-ci.md)
