...
决策依据：[运行保存](../../.agents/agent_notes/product/README.md#p-20260909-run-persistence)、[Harness](../../.agents/agent_notes/product/README.md#p-20260909-harness-adapter)。前端、接入清单与招聘工作流由 #39 的后续 stack 层提供。
