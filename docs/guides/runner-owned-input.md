...
Catalog 的 node/checkpoint/restore 目录、独立 ArtifactStore 临时快照及分配后尚未提交记录的窗口仍需后续处理，不能把本次输入调整当作完整崩溃 GC。[验证记录](../validation/2026-09-10-owned-runner-input.md) · [资源恢复](runner-resource-recovery.md)
