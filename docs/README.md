...
**当前状态：可运行确定性 Component、JSON contract、Docker Runner 与受控 CONNECT 联网、独立 Harness 计划/parser 与私有凭据存储/执行绑定测试。完整 Workflow、文件 contract、真实认证/Harness 组合、持久化、队列、重试和并行尚未实现。**
